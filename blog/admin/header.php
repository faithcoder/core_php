            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li <?= $page == 'manage-category.php' ? 'class="active"':'' ?>><a  href="manage-category.php">Manage Category</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li <?= $page == 'add-blog.php' ? 'class="active"':'' ?>><a  href="add-blog.php" >Add Blog Post</a></li>
