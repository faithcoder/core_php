...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `task` SET `subject`='$subject',`date`='$date',`category`='$category',`put_up`='$put_up', `action`='$action',`rmk`='$rmk' WHERE `id` = '$id' ";
                ...
                <form action="<?= $_SERVER['PHP_SELF']?>" method="post">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="category" class="form-control" value="<?= $row['category']; ?>">
                       ...
                       <tr>
                            ...
                            <td>
                                <select id="" name="put_up" class="form-control" value="<?= $row['put_up']; ?>">
                       ...
                       <tr>
                            <th>Action</th>
                            <td><input type="text" name="action" class="form-control" value="<?= $row['action']; ?>"></td>
                        </tr>
                        <tr>
                            <th>Rmk (If Any)</th>
                            <td><input type="text" name="rmk" class="form-control" value="<?= $row['rmk']; ?>"></td>
                        </tr>-->
                        <tr><td>
